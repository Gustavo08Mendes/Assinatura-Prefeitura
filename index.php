...
.form-contatos input[type="text"]{
    ...
    text-align: left;
    margin-bottom: 20px;
	outline-color: #395aad;
}
.form-contatos input[type="password"]{
    display: inline-block;
    font-size: 16px;
    border: 2px solid #e3e3e3;
    border-radius: 5px;
...
if ($erro == "erro") { echo "<center><H2><font color=red>Erro no login, favor testar novamente.</font></h2></center><br>";  }else{ echo "<div class='titulo_2'><h2>Digite seu usuário e senha da rede.</h2></div>"; }
...
?>
    ...
    <form method="post" action="ass.php" name="form" AUTOCOMPLETE='ON' onSubmit="return valida()" class="formulario">
        ...
        <div class="formulario" id="container_formulario">
          ...
          Usuário de rede:
              <input type="text" name="usuario" maxlength="7" class="campo-pesquisa-contatos">
          </div>
		<div class="form-contatos">
		
		Senha de rede:&nbsp;&nbsp;
			<input type="password" name="senha" id="pass" class="campo-pesquisa-contatos" maxlength="30" > <img src="olho (1).png" id="olho" class="olho" alt="Clique para visualizar a senha.">
            <div class="botao_inserir"><input type="submit" value="Entrar" class="carregar_btn"disabled></div>
        </div>
    </form>
